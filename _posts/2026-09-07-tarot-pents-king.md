...
- [펜타클 여왕(Queen of Pentacles)](/ko/posts/tarot-pents-queen/) — 내적으로 무르익은 돌봄이 여왕이라면, 그것이 바깥을 향한 책임과 권위로 확장된 모습이 왕입니다. 흙 원소의 성숙이 완성되는 한 쌍입니다.
- [소드 왕(King of Swords)](/ko/posts/tarot-swords-king/) — 같은 왕이라도 소드 왕이 원칙과 논리로 다스린다면, 펜타클 왕은 결과와 실물로 다스립니다. 네 왕을 비교해 보면 각 원소가 권위를 표현하는 방식의 차이가 뚜렷해집니다.
